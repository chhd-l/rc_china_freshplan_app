                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              const Text('订单编号', style: TextStyle(
                                color: Color(0xFF666666)
                              )),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        Clipboard.setData(ClipboardData(text: logic.orderNumber.value));
                                      },
                                      child: const Icon(
                                        Icons.library_books,
                        ...
                        Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              const Text('计划编号', style: TextStyle(
                                color: Color(0xFF666666)
                              )),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.end,
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: GestureDetector(
                                      onTap: () {
                                        Clipboard.setData(ClipboardData(text: logic.subscriptionNo.value));
                                      },
                                      child: const Icon(
                                        Icons.library_books,
                                        color: Color(0xFF96CC39),
                        ...
                        Container(
                          margin: const EdgeInsets.only(bottom: 12),
                          alignment: Alignment.topLeft,
                          child: const Text('备注', style: TextStyle(
                            color: Color(0xFF666666),
                          ))
                        ),
                        TextField(
