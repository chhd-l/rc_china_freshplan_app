            ...
            child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                        child: (orders.length == null ? 0 : orders.length) == 0
                            ? Container(
                            ...
                            : Container(
                                ...
                                child: ListView.builder(
                                  ...
                                  shrinkWrap: true,
                                  itemCount:
                                      orders.length == null ? 0 : orders.length,
                                                      ...
                                                      ? Container(
                                                          ...
                                                          child: MaterialButton(
                                                            ...
                                                            textColor:
                                                                const Color(
                                                                    0xFF96CC39),
                                                            child: Text(returnDetermine(orders[
                                                                        i][
                                                                    'orderState']
                                                                [
                                                                'orderState'])),
